...
P["pristine_alien"] = dict(
    globe=dict(**{"Continent Scale": 2.1, "Continent Coverage": 0.46, "Relief Strength": 78.0,
    ...
    surface={"Vegetation Hue": (0.230, 0.020, 0.075, 1), "Rock Hue": (0.145, 0.055, 0.058, 1),
             ...
             "Shelf Boost": 1.25, "Vegetation Amount": 1.35, "River Tint": 0.95,
             "Ice Temp Threshold": 0.16, "Patchiness": 0.45, "Tech Level": 0.0, "Vegetation Clumping": 0.85, "Foam Amount": 0.7, "Glint Variation": 0.6, "Strata Amount": 0.3},
    clouds={"Cloud Coverage": 0.34, "Cloud Density": 1.1, "Band Strength": 0.42, "Detail Scale": 1.2},
    atmo={"Density": 0.0092, "Atmo Colour": (0.30, 0.42, 1.0, 1), "Falloff": 3.0, "Pollution": 0.0},
    rings=False, orbital=0.0)

P["earthlike"] = dict(
    globe={"Continent Scale": 1.75, "Continent Coverage": 0.40, "Relief Strength": 68.0,
    ...
    surface={"Vegetation Hue": (0.072, 0.128, 0.040, 1), "Rock Hue": (0.190, 0.150, 0.115, 1),
             ...
             "Shelf Boost": 1.15, "Vegetation Amount": 1.15, "River Tint": 0.55,
             "Ice Temp Threshold": 0.21, "Patchiness": 0.35, "Tech Level": 0.0, "Glint Variation": 0.75, "Foam Amount": 0.85, "Vegetation Clumping": 0.55, "Strata Amount": 0.28, "Ice Crack Amount": 0.35},
    clouds={"Cloud Coverage": 0.62, "Cloud Density": 1.35, "Band Strength": 0.52, "Detail Scale": 1.25},
    atmo={"Density": 0.0082, "Atmo Colour": (0.22, 0.44, 1.0, 1), "Falloff": 3.2, "Pollution": 0.0},
    rings=False, orbital=0.0)

P["colonial_outpost"] = dict(
    globe={"Continent Scale": 1.9, "Continent Coverage": 0.38, "Relief Strength": 72.0,
    ...
    surface={"Vegetation Hue": (0.070, 0.108, 0.048, 1), "Rock Hue": (0.180, 0.148, 0.118, 1),
             ...
             "Shelf Boost": 1.10, "Vegetation Amount": 1.0, "River Tint": 0.60,
             "Patchiness": 0.35, "Tech Level": 3.0, "Light Colour Temp": 0.12,
             "Urban Density": 1.65, "Night Light Intensity": 3.8,
             "Road Network Visibility": 1.1, "Agriculture Coverage": 0.9, "Glint Variation": 0.55, "Foam Amount": 0.6, "Vegetation Clumping": 0.4, "Strata Amount": 0.35, "Dune Amount": 0.25},
    clouds={"Cloud Coverage": 0.50, "Cloud Density": 1.2, "Band Strength": 0.50, "Detail Scale": 1.2},
    atmo={"Density": 0.0082, "Atmo Colour": (0.24, 0.44, 1.0, 1), "Falloff": 3.2, "Pollution": 0.05},
    rings=False, orbital=1.5)

P["industrial_world"] = dict(
    globe={"Continent Scale": 1.7, "Continent Coverage": 0.47, "Relief Strength": 62.0,
    ...
    surface={"Vegetation Hue": (0.078, 0.092, 0.044, 1), "Rock Hue": (0.170, 0.140, 0.115, 1),
             ...
             "Shelf Boost": 1.05, "Vegetation Amount": 0.60, "River Tint": 0.50,
             "Patchiness": 0.30, "Tech Level": 6.0, "Light Colour Temp": 0.35,
             "Urban Density": 1.35, "Night Light Intensity": 1.5,
             "Road Network Visibility": 1.4, "Agriculture Coverage": 1.2, "Glint Variation": 0.45, "Foam Amount": 0.5, "Strata Amount": 0.4},
    clouds={"Cloud Coverage": 0.58, "Cloud Density": 1.3, "Band Strength": 0.55, "Detail Scale": 1.1},
    atmo={"Density": 0.0135, "Atmo Colour": (0.34, 0.36, 0.62, 1), "Falloff": 2.6, "Pollution": 0.62},
    rings=False, orbital=4.0)

P["hyperdeveloped"] = dict(
    globe={"Continent Scale": 1.8, "Continent Coverage": 0.42, "Relief Strength": 58.0,
    ...
    surface={"Vegetation Hue": (0.060, 0.085, 0.058, 1), "Rock Hue": (0.140, 0.140, 0.140, 1),
             ...
             "Shelf Boost": 1.0, "Vegetation Amount": 0.55, "River Tint": 0.35,
             "Patchiness": 0.18, "Tech Level": 9.0, "Light Colour Temp": 0.85,
             "Urban Density": 1.5, "Night Light Intensity": 1.9,
             "Grid Network Intensity": 1.5, "Megastructure Scale": 1.2, "Glint Variation": 0.4, "Foam Amount": 0.4, "Strata Amount": 0.25},
    clouds={"Cloud Coverage": 0.36, "Cloud Density": 1.0, "Band Strength": 0.5, "Detail Scale": 1.1},
    atmo={"Density": 0.0095, "Atmo Colour": (0.26, 0.44, 0.95, 1), "Falloff": 3.0, "Pollution": 0.28},
...
P["megastructure"] = dict(
    globe={"Continent Scale": 1.85, "Continent Coverage": 0.44, "Relief Strength": 55.0,
    ...
    surface={"Vegetation Hue": (0.055, 0.080, 0.062, 1), "Rock Hue": (0.130, 0.132, 0.136, 1),
             ...
             "Shelf Boost": 1.0, "Vegetation Amount": 0.45, "River Tint": 0.30,
             "Patchiness": 0.14, "Tech Level": 10.0, "Light Colour Temp": 0.95,
             "Urban Density": 1.6, "Night Light Intensity": 2.0,
             "Grid Network Intensity": 0.7, "Megastructure Scale": 1.6, "Glint Variation": 0.4, "Foam Amount": 0.35},
    clouds={"Cloud Coverage": 0.32, "Cloud Density": 0.95, "Band Strength": 0.5, "Detail Scale": 1.1},
    atmo={"Density": 0.0090, "Atmo Colour": (0.28, 0.46, 1.0, 1), "Falloff": 3.0, "Pollution": 0.20},
...
P["ringed_ice"] = dict(
    globe={"Continent Scale": 1.6, "Continent Coverage": 0.34, "Relief Strength": 60.0,
    ...
    surface={"Vegetation Hue": (0.070, 0.100, 0.090, 1), "Rock Hue": (0.180, 0.185, 0.200, 1),
             ...
             "Shelf Boost": 1.30, "Vegetation Amount": 0.25, "River Tint": 0.40,
             "Ice Temp Threshold": 0.46, "Patchiness": 0.24, "Tech Level": 0.0, "Ice Crack Amount": 0.9, "Foam Amount": 0.3, "Strata Amount": 0.2},
    clouds={"Cloud Coverage": 0.55, "Cloud Density": 1.15, "Band Strength": 0.62, "Detail Scale": 1.0,
            "Cloud Colour": (0.94, 0.97, 1.0, 1)},
    atmo={"Density": 0.0080, "Atmo Colour": (0.30, 0.52, 1.0, 1), "Falloff": 3.2, "Pollution": 0.0},
...
P["volcanic"] = dict(
    globe={"Continent Scale": 2.3, "Continent Coverage": 0.66, "Relief Strength": 96.0,
    ...
    surface={"Vegetation Hue": (0.150, 0.030, 0.008, 1), "Rock Hue": (0.055, 0.040, 0.038, 1),
             ...
             "Shelf Boost": 2.4, "Vegetation Amount": 0.0, "River Tint": 1.6,
    ...
    atmo={"Density": 0.0150, "Atmo Colour": (0.62, 0.26, 0.10, 1), "Falloff": 2.4, "Pollution": 0.45},
    rings=False, orbital=0.0)

P["frozen"] = dict(
    globe={"Continent Scale": 1.7, "Continent Coverage": 0.44, "Relief Strength": 66.0,
    ...
    surface={"Vegetation Hue": (0.080, 0.100, 0.105, 1), "Rock Hue": (0.170, 0.178, 0.195, 1),
             ...
             "Shelf Boost": 1.4, "Vegetation Amount": 0.0, "River Tint": 0.30,
    ...
    atmo={"Density": 0.0070, "Atmo Colour": (0.34, 0.56, 1.0, 1), "Falloff": 3.4, "Pollution": 0.0},
    rings=False, orbital=0.0)

P["desert"] = dict(
    globe={"Continent Scale": 1.55, "Continent Coverage": 0.80, "Relief Strength": 74.0,
    ...
    surface={"Vegetation Hue": (0.150, 0.130, 0.055, 1), "Rock Hue": (0.235, 0.150, 0.092, 1),
             ...
             "Shelf Boost": 1.2, "Vegetation Amount": 0.16, "River Tint": 0.75,
    ...
    atmo={"Density": 0.0105, "Atmo Colour": (0.60, 0.42, 0.30, 1), "Falloff": 2.8, "Pollution": 0.22},
    rings=False, orbital=0.5)

P["ocean_world"] = dict(
    globe={"Continent Scale": 1.45, "Continent Coverage": 0.11, "Relief Strength": 52.0,
    ...
    surface={"Vegetation Hue": (0.062, 0.120, 0.055, 1), "Rock Hue": (0.170, 0.145, 0.115, 1),
             ...
             "Shelf Boost": 1.5, "Vegetation Amount": 1.2, "River Tint": 0.50,
             "Patchiness": 0.30, "Tech Level": 1.0, "Light Colour Temp": 0.3, "Glint Variation": 1.0, "Foam Amount": 1.0, "Vegetation Clumping": 0.3},
    clouds={"Cloud Coverage": 0.55, "Cloud Density": 1.2, "Band Strength": 0.58, "Detail Scale": 1.2},
    atmo={"Density": 0.0085, "Atmo Colour": (0.20, 0.44, 1.0, 1), "Falloff": 3.2, "Pollution": 0.0},
    rings=False, orbital=0.6)

P["dead_moon"] = dict(
    globe={"Continent Scale": 2.0, "Continent Coverage": 0.95, "Relief Strength": 88.0,
    ...
    surface={"Vegetation Hue": (0.10, 0.10, 0.10, 1), "Rock Hue": (0.115, 0.112, 0.108, 1),
             ...
             "Shelf Boost": 1.0, "Vegetation Amount": 0.0, "River Tint": 0.0,
             "Ice Temp Threshold": 0.0, "Patchiness": 0.42, "Tech Level": 0.0,
             "Micro Disp Height": 3.4, "Crater Amount": 0.95, "Crater Scale": 30.0, "Strata Amount": 0.45},
    clouds={"Cloud Coverage": 0.0, "Cloud Density": 0.0, "Band Strength": 0.5, "Detail Scale": 1.0},
    atmo={"Density": 0.0006, "Atmo Colour": (0.5, 0.5, 0.5, 1), "Falloff": 4.0, "Pollution": 0.0},
    rings=False, orbital=0.0)

P["gas_giant"] = dict(
    globe={"Continent Scale": 1.2, "Continent Coverage": 0.02, "Relief Strength": 2.0,
    ...
    atmo={"Density": 0.0180, "Atmo Colour": (0.62, 0.50, 0.34, 1), "Falloff": 2.2, "Pollution": 0.0},
    rings=True, orbital=0.0,
...
LOOK_DEFAULTS = {
    ...
    "Shelf Boost": 1.10, "Slope Rock Threshold": 0.26, "Vegetation Amount": 1.0,
    "Ice Temp Threshold": 0.20, "River Tint": 0.30, "Patchiness": 0.35,
    "Lava Emission": 0.0, "Micro Disp Height": 2.2, "Micro Disp Scale": 145.0,
    ...
    "Glint Variation": 0.0, "Foam Amount": 0.0,
...
CLOUD_DEFAULTS = {"Cloud Coverage": 0.55, "Cloud Density": 1.25, "Band Strength": 0.52,
                  ...
                  "Cloud Relief": 0.30}
ATMO_DEFAULTS = {"Density": 0.0080, "Atmo Colour": (0.22, 0.44, 1.0, 1),
